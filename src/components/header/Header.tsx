    ...
    <div className="header">
      <div className="header-add-wrapper">
        <Link to="" className="header-add">
          Get £10 off selected items when you spend £70 with code: TREAT
        </Link>
      </div>
      <div className="header-menu">
        <div className="header-menu-block header-menu-block-divider">
          <Link to="">
            Head to the app for a FREE gift from Made by Mitchell worth £16,
            plus exclusive discounts!
          </Link>
        </div>
        <div className="header-menu-block header-menu-block-divider">
          <Link to="">
            FREE delivery over £25 OR spend £60 for FREE next day delivery
          </Link>
        </div>
      ...
      <div className="container">
        <nav className="nav">
          ...
          <div className="nav_input">
            <img
              ...
              alt=""
            />
            <form className="FromSerach" onSubmit={handleSearch}>
              <input
                type="text"
              ...
              />
              <button className="SeachBtn" type="submit"></button>
            </form>
        ...
        <div className="nav-items">
          <ul className="nav-items_list">
            ...
            <li>
              <Link to="" className="nav-items_link">
                Makeup
              </Link>
            </li>
            <li>
