  ...
  return (
    ...
    <div className="header-menu">
      ...
      <div className="header-menu-block header-menu-block-item">
        <div>
          <Link to="" className="header-menu-block-lang">
            <img
        ...
        <div>
          <Link to="" className="header-menu-block-lang">GPB</Link>
        </div>
      </div>
    </div>
    ...
    <div className="container">
      ...
      <div className="nav-items">
        <ul className="nav-items_list">
          ...
          <li>
            <Link to="" className="nav-items_link">Makeup</Link>
          </li>
          <li>
            <Link to="" className="nav-items_link">Skincare</Link>
          </li>
          <li>
            <Link to="" className="nav-items_link">Haircare</Link>
          </li>
          <li>
            <Link to="" className="nav-items_link">Fragrance</Link>
          </li>
          <li>
            <Link to="" className="nav-items_link">Bath & Body</Link>
          </li>
          <li>
            <Link to="" className="nav-items_link">Wellness</Link>
          </li>
          <li>
            <Link to="" className="nav-items_link">Accessories</Link>
          </li>
          <li>
            <Link to="" className="nav-items_link">Gifting</Link>
          </li>
        </ul>
      </div>
    </div>
