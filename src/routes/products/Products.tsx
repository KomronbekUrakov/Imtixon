...
const Products: React.FC = () => {
  ...
  const handleLikeProduct = (product: Product) => {
    const exists = likedProducts.some((likedProduct: Product) => likedProduct.id === product.id);
    if (exists) {
    ...
    <div className="products-products">
      <div className="container">
        ...
        {isLoading ? (
          ...
          <div className="products-products-content">
            {products.slice(0, limit).map((product: Product) => {
              const isLiked = likedProducts.some((likedProduct: Product) => likedProduct.id === product.id);
              return (
                <div className="products-products-card" key={product.id}>
                  ...
                  <div className="products-products-card-content">
                    <h3 className="products-products-card-title">{product.name}</h3>
        ...
        {products.length > limit && (
          <button onClick={handleShowMore} className="ShowBtn">
            Show More Products
          </button>
        )}
      </div>
